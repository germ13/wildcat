...
{
    public partial class TLabImportStressCorrosion
    {
        public TLabImportStressCorrosion()
        {
            TLabImportStressCorrosionResultSet = new HashSet<TLabImportStressCorrosionResultSet>();
        }
        ...
        public ICollection<TLabImportStressCorrosionResultSet> TLabImportStressCorrosionResultSet { get; set; }
    }
}
