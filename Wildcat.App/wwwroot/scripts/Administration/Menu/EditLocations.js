function changeWorkerAlarmStatus(e) {
    var sub_id = e.id.split("|")[0].split("-")[1];
    var worker_id = e.id.split("|")[1].split("-")[1];
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            //});
            if (result.check) {
                toastr['success'](sub_id + ' added to ' + worker_id, 'Success: modified!', {
                    positionClass: 'toast-top-right',
                    closeButton: true,
                    progressBar: false,
                    preventDuplicates: true,
                ...
                toastr['success'](sub_id + ' removed from ' + worker_id, 'Success: modified!', {
                    positionClass: 'toast-top-right',
                    closeButton: true,
                    progressBar: false,
                    preventDuplicates: true,
        ...
        error: function (result) {
            toastr['error']('Plant menu : ' + worker_id + ' not modified', 'Error!', {
                positionClass: 'toast-top-right',
                closeButton: true,
                progressBar: false,
                preventDuplicates: true,
...
var Treeview = function () {
    var demo6 = function () {
        ...
        $("#fromTree").on("click", ".jstree-anchor", function (e) {
            ...
            $.ajax({
                url: "/Administration/Menu/LocationsMenuTreeClick/" + id,
                type: "GET",
                cache: false,
                success: function (result) {
