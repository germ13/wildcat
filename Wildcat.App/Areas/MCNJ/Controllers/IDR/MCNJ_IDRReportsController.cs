...
namespace Wildcat.App.Controllers.MCNJ.IDR
{
    public class MCNJ_IDRReportsController : Controller
    {
        ...
        public MCNJ_IDRReportsController(IDRContext context, IHttpContextAccessor httpContextAccessor, IViewRenderService viewRenderService)
        {
        ...
        {
            IDRReportsViewModel vm = new IDRReportsViewModel(_httpContextAccessor, _viewRenderService, _context);
            return View(vm);
        }
        ...
        public JsonResult EditRequestPartial(string ID)
        {
            ...
            try
            {
                response.Form = _viewRenderService.RenderToStringAsync("MCNJ/IDR/DieChange/EditRequestPartial", vm);
        ...
        [HttpPost]
        public IActionResult GetSelectedReports(string ReportType, string ToolNumber, DateTime? StartDate, DateTime? EndDate)
        {
            var response = new GetSelectedReportsResponse(_context, _viewRenderService, ReportType, ToolNumber, StartDate, EndDate);
        ...
        //    IDRReportsDataTableData dataTableData = new IDRReportsDataTableData(_context, _viewRenderService, draw, start, length, search, sortColumn, sortDirection);
