...
{
    [Area("MCNJ")]
    public class DieChangeReportsController : Controller
    {
        ...
        public DieChangeReportsController(DCRContext context, IHttpContextAccessor httpContextAccessor, IViewRenderService viewRenderService)
        {
        ...
        {
            DCRReportsViewModel vm = new DCRReportsViewModel(_httpContextAccessor, _viewRenderService, _context);
            return View(vm);
        }
        ...
        //    DCRReportsDataTableData dataTableData = new DCRReportsDataTableData(_context, _viewRenderService, draw, start, length, search, sortColumn, sortDirection);
